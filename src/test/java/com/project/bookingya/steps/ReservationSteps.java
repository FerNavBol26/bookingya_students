...
public class ReservationSteps {
    ...
    public void givenRegisteredGuest() {
        ...
        guest.setEmail("carlos-" + UUID.randomUUID() + "@example.com");
    ...
    public void givenMultipleReservations() {
        ...
        givenAvailableRoom();
        UUID room1Id = currentRoomId;
        givenRegisteredGuest();
        UUID guest1Id = currentGuestId;
        
        ReservationDto dto1 = new ReservationDto();
        dto1.setGuestId(guest1Id);
        dto1.setRoomId(room1Id);
        ...
        // Crear segunda reserva con otra habitación
        givenAvailableRoom();
        UUID room2Id = currentRoomId;
        
        ReservationDto dto2 = new ReservationDto();
        dto2.setGuestId(guest1Id);
        dto2.setRoomId(room2Id);
